...
#         logging.info(f"Повідомлення в Telegram успішно відправлено: '{caption}'")
#     except requests.exceptions.RequestException as e:
#         logging.error(f"Помилка відправлення повідомлення в Telegram: {e}")
...
#         target_image_file = 'directory/source/obama1.jpg'
...
#           # Видалення цільового фото
#         try:
#             os.remove(target_image_file)
#             logging.info(f"Видалено цільове фото: {target_image_file}")
...
#         time.sleep(7) # Затримка в 60 секунд (1 хвилина)
import boto3
import logging
import os
import requests
